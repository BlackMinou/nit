...
class Assets
	...
	var wall_destruction = new Sound("walld")

	# Sound when the ball bounce
	var bounce = new Sound("bounce")
	...
	fun load do
		ball = app.load_asset("images/ball.png").as(Image)
		horizontal_wall = app.load_asset("images/horizontal_wall.png").as(Image)
		vertical_wall = app.load_asset("images/vertical_wall.png").as(Image)
